...
def upgrade() -> None:
    ...
    op.execute("""
        ...
        VALUES
        (1, 'Test District A', 'district', 1, ST_GeomFromText('MULTIPOLYGON(((30.20 59.90, 30.50 59.90, 30.50 60.10, 30.20 60.10, 30.20 59.90)))', 4326)),
        (2, 'Test District B', 'district', 1, ST_GeomFromText('MULTIPOLYGON(((30.50 59.90, 30.80 59.90, 30.80 60.10, 30.50 60.10, 30.50 59.90)))', 4326))
    """)
